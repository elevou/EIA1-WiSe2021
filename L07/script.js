window.addEventListener("load", function () {
    ...
    /* */
    var samples = ['assets/A.mp3', 'assets/C.mp3', 'assets/F.mp3', 'assets/G.mp3', 'assets/hihat.mp3', 'assets/kick.mp3', 'assets/laugh-1.mp3', 'assets/laugh-2.mp3', 'assets/snare.mp3'];
    /* */
    function playSound(tlink) {
        var sound = new Audio(tlink);
        sound.play();
    }
    /* */
    function playBeat() {
